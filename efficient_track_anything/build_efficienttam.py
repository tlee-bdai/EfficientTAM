...
def build_efficienttam_online_tracker(
    config_file,
    ckpt_path=None,
    device="cuda",
    mode="eval",
    ...
    **kwargs,
    ...
    hydra_overrides = [
        "++model._target_=efficient_track_anything.efficienttam_online_tracker.EfficientTAMOnlineBatchTracker",
    ]
    if vos_optimized:
        hydra_overrides = [
            "++model._target_=efficient_track_anything.efficienttam_online_tracker.EfficientTAMOnlineBatchTrackerVOS",
            "++model.compile_image_encoder=True",  # Let efficienttam_base handle this
        ]
